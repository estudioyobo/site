    ...
    <footer>
      <div className='row margin equal elements'>
        ...
        <div className='footer-logo'>
          ...
          <Button small onClick={() => setNewsletter(true)}>Suscríbete a la newsletter!</Button>
        </div>
      </div>
      <div className='row'>
      ...
      <Modal isOpen={newsletter} onRequestClose={() => setNewsletter(false)} style={modalStyles}>
        <Newsletter title='Suscríbete a la newsletter' subtitle='y entérate de noticias del mundo del diseño y desarrollo del mundo digital' path='footer' />
      </Modal>
    </footer>
  )
}
